// Package cli assembles the gfg command tree from the gfg
...
// NewApp assembles the kit application from the gfg domain. The
...
//
// To add a command, declare it in gfg/domain.go with kit.Handle and it
