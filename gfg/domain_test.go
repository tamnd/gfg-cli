...
// HTTP behaviour is covered in gfg_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "gfg://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("gfg", "about")
	if err != nil || got.String() != "gfg://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want gfg://page/about", got.String(), err)
	}
}
