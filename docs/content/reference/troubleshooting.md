...
Most of these come down to network reality or how gfg serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

gfg rate-limits like any public site. gfg already paces
...
Where a surface is gated, gfg reads a cookie or token you supply
...
`gfg`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what gfg actually did
